                             ...
                             [[maybe_unused]] std::size_t num_elements)
{
  ...
  for (uint32_t e = 0; e < num_elements; e++) {
    ...
    auto* vec_ptr = reinterpret_cast< tensor<double, 2 * test_element::ndof * test_element::components> * >(&dK(e, 0, 0));
    ...
    for (int i = 0; i < 2 * trial_element::ndof * trial_element::components; i++) {
